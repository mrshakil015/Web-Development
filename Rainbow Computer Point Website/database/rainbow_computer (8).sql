...
INSERT INTO `studentinfo` (`Id`, `RollNo`, `Coursename`, `Batch`, `Section`, `StudentName`, `FatherName`, `MotherName`, `Gender`, `Dob`, `Address`, `Email`, `Mobile`, `StudentPhoto`, `Password`) VALUES
(1, '1211', 'Office Application Program', '10:00 AM', 'A', 'Md. Shakil', 'Md. Bashir', 'Halima', 'Male', '3/3/01', 'Hemayetpur', 'shakil.eub.cse@gmail.com', '017889891283', 'instructor.JPG', '017889891283'),
(2, '121', 'Office Application Program', '11:30 AM', 'A', 'Md. Shakil', 'Md. Bashir', 'Halima', 'Male', '3/3/01', 'Hemayetpur', 'shakil.eub.cse@gmail.com', '017889891283', 'instructor.JPG', '017889891283');
